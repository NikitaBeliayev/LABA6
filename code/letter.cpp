...
#include <QDebug>
GLfloat VertexArray[100][3];
GLubyte IndexArray[100][4];
...
void letter::getVertexArray(float k){
    ...
    VertexArray[22][0]=1.25*k;
    VertexArray[22][1]=0;
    VertexArray[22][2]=-0.25*k;

    VertexArray[23][0]=1.25*k;
    VertexArray[23][1]=0;
    VertexArray[23][2]=0;

    VertexArray[24][0]=0.25*k;
    VertexArray[24][1]=0.25*k;
    VertexArray[24][2]=0;

    VertexArray[25][0]=0.25*k;
    VertexArray[25][1]=0.25*k;
    VertexArray[25][2]=-0.25*k;

    VertexArray[26][0]=1.25*k;
    VertexArray[26][1]=0.25*k;
    VertexArray[26][2]=-0.25*k;

    VertexArray[27][0]=1.25*k;
    ...
    VertexArray[29][1]=0.25*k;
    VertexArray[29][2]=0;

    VertexArray[30][0]=1.25*k;
    VertexArray[30][1]=0.25*k;
    VertexArray[30][2]=0;
    ...
    VertexArray[34][0]=1.25*k;
    VertexArray[34][1]=0.25*k;
    VertexArray[34][2]=-0.25*k;

    VertexArray[35][0]=1.25*k;
    VertexArray[35][1]=0;
    ...
    VertexArray[38][0]=1.25*k;
    VertexArray[38][1]=1*k;
    VertexArray[38][2]=-0.25*k;

    VertexArray[39][0]=1.25*k;
    VertexArray[39][1]=0.75*k;
    VertexArray[39][2]=-0.25*k;

    VertexArray[40][0]=0.25*k;
    VertexArray[40][1]=0.75*k;
    VertexArray[40][2]=0;

    VertexArray[41][0]=0.25*k;
    ...
    VertexArray[43][0]=1.25*k;
    VertexArray[43][1]=0.75*k;
    VertexArray[43][2]=0;
    ...
    VertexArray[46][1]=0.75*k;
    VertexArray[46][2]=-0.25*k;

    VertexArray[47][0]=1.25*k;
    VertexArray[47][1]=0.75*k;
    VertexArray[47][2]=0;
    ...
    VertexArray[51][1]=1*k;
    VertexArray[51][2]=0;

    VertexArray[52][0]=1*k;
    VertexArray[52][1]=0.25*k;
    VertexArray[52][2]=0;

    VertexArray[53][0]=1*k;
    VertexArray[53][1]=0.75*k;
    VertexArray[53][2]=0;

    VertexArray[54][0]=1.25*k;
    VertexArray[54][1]=0.75*k;
    VertexArray[54][2]=0;

    VertexArray[55][0]=1.25*k;
    VertexArray[55][1]=0.25*k;
    VertexArray[55][2]=0;

    VertexArray[56][0]=1.25*k;
    VertexArray[56][1]=0.25*k;
    VertexArray[56][2]=0;

    VertexArray[57][0]=1.25*k;
    VertexArray[57][1]=0.75*k;
    VertexArray[57][2]=0;

    VertexArray[58][0]=1.25*k;
    VertexArray[58][1]=0.75*k;
    VertexArray[58][2]=-0.25*k;

    VertexArray[59][0]=1.25*k;
    VertexArray[59][1]=0.25*k;
    VertexArray[59][2]=-0.25*k;

    VertexArray[60][0]=0.25*k;
    VertexArray[60][1]=2*k;
    VertexArray[60][2]=0;

    VertexArray[61][0]=0.25*k;
    VertexArray[61][1]=2*k;
    VertexArray[61][2]=-0.25*k;

    VertexArray[62][0]=1.25*k;
    VertexArray[62][1]=2*k;
    VertexArray[62][2]=-0.25*k;

    VertexArray[63][0]=1.25*k;
    VertexArray[63][1]=2*k;
    VertexArray[63][2]=0;

    VertexArray[64][0]=0.25*k;
    VertexArray[64][1]=1.75*k;
    VertexArray[64][2]=0;

    VertexArray[65][0]=0.25*k;
    VertexArray[65][1]=1.75*k;
    VertexArray[65][2]=-0.25*k;

    VertexArray[66][0]=1.25*k;
    VertexArray[66][1]=1.75*k;
    VertexArray[66][2]=-0.25*k;

    VertexArray[67][0]=1.25*k;
    ...
    VertexArray[69][0]=0.25*k;
    VertexArray[69][1]=2*k;
    VertexArray[69][2]=0;

    VertexArray[70][0]=1.25*k;
    VertexArray[70][1]=2*k;
    VertexArray[70][2]=0;

    VertexArray[71][0]=1.25*k;
    VertexArray[71][1]=1.75*k;
    VertexArray[71][2]=0;

    VertexArray[72][0]=1.25*k;
    VertexArray[72][1]=1.75*k;
    VertexArray[72][2]=0;
    ...
    VertexArray[74][1]=2*k;
    VertexArray[74][2]=-0.25*k;

    VertexArray[75][0]=1.25*k;
    VertexArray[75][1]=1.75*k;
    VertexArray[75][2]=-0.25*k;


    VertexArray[76][0]=0.25*k;
    VertexArray[76][1]=1.75*k;
    VertexArray[76][2]=-0.25*k;

    VertexArray[77][0]=0.25*k;
    VertexArray[77][1]=2*k;
    VertexArray[77][2]=-0.25*k;

    VertexArray[78][0]=1.25*k;
    VertexArray[78][1]=2*k;
    VertexArray[78][2]=-0.25*k;

    VertexArray[79][0]=1.25*k;
    VertexArray[79][1]=1.75*k;
    VertexArray[79][2]=-0.25;
...
void letter::draw_rotation_z()
{
    ...
    glDrawElements(GL_QUADS, 53, GL_UNSIGNED_BYTE, IndexArray);
...
void letter::draw_rotation_y()
{
    ...
    glVertexPointer(3, GL_FLOAT, 0, c);
    glDrawElements(GL_QUADS, 100, GL_UNSIGNED_BYTE, IndexArray);
